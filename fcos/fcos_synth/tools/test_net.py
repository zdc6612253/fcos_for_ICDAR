...
def main():
    ...
    for output_folder, dataset_name, data_loader_val in zip(output_folders, dataset_names, data_loaders_val):  # 不同测试数据集
        inference(
            model,
            data_loader_val,
            ...
            txt_path=cfg.DATASETS.TXT_PATH,
            json_path=cfg.DATASETS.JSON_PATH,
            iou_thresh=cfg.MODEL.FCOS.NMS_TH_INFER,
            ignore_iou=cfg.MODEL.FCOS.IGNORE_IOU,
        )
        synchronize()
