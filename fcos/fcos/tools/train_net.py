...
def train(cfg, local_rank, distributed):
    ...
    extra_checkpoint_data = checkpointer.load(cfg.MODEL.WEIGHT, cfg.MODEL.RESUME)
    arguments.update(extra_checkpoint_data)

    if not cfg.MODEL.RESUME:
        arguments["iteration"] = 0
    ...
    # for (images, targets, score_maps) in data_loader:
...
def main():
    ...
    args.distributed = num_gpus > 1  # 卡数
