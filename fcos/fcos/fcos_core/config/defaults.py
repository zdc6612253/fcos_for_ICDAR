...
_C.DATASETS.TEST = ()
_C.DATASETS.TXT_PATH = None
_C.DATASETS.JSON_PATH = None
_C.DATASETS.AUG = True
_C.DATASETS.FIX_CROP = False
_C.DATASETS.MAX_ROTATE_THETA = 90
...
_C.MODEL.FCOS.INFERENCE_TH =0.7   # 0.75 test:0.80  train:0.999
_C.MODEL.FCOS.NMS_TH = 0.1  # 0.3
_C.MODEL.FCOS.PRE_NMS_TOP_N = 1000
_C.MODEL.FCOS.NMS_TH_INFER = 0.5  # 评价时IOU的阈值
_C.MODEL.FCOS.IGNORE_IOU = 0.5  # 评价时计算ignore和pre的IOU阈值
...
_C.MODEL.FCOS.USE_GFLOSS = True
_C.MODEL.FCOS.GFLOSS_BETA = 2.0
_C.MODEL.FCOS.QFLOSS_WEIGHT = 0.5
